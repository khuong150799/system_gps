...
const { tableTypeAiSafe } = require("../constants/tableName.constant");

class TypeAiSafeModel extends DatabaseModel {
  constructor() {
    super();
  }
  ...
  async getallrows(conn, query) {
    ...
    const [res_, count] = await Promise.all([
      ...
      this.count(conn, tableTypeAiSafe, "*", where, conditions),
    ]);
...
module.exports = new TypeAiSafeModel();
